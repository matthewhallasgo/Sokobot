...
class PuzzleSolver {
    ...
    private int[][][] trueDistances; // added
    ...
    private void precomputeTrueDistances() { // added method
        ...
        for (int i = 0; i < totalTargets; i++) {
            ...
            while (!queue.isEmpty()) {
                ...
                for (int[] d : dirs) {
                    ...
                    if (nr >= 0 && nr < height && nc >= 0 && nc < width && !wall[nr][nc]) {
    ...
    public String solve(int playerRow, int playerCol, char[][] itemsData) {
        ...
        while (!openSet.isEmpty()) {
            ...
            if (current.hCost >= 999_999) { // added
                continue;
            }
    ...
    private int heuristic(int playerPos, int[] crates) { // modified to true distance with Manhattan
        ...
        for (int cratePos : crates) {
            ...
            if (bestTarget != -1 && bestDist != Integer.MAX_VALUE) {
